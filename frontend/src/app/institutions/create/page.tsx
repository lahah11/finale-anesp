    ...
    <DashboardLayout>
      <div className="space-y-6">
        ...
        <div className="flex items-center space-x-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Nouvelle institution</h1>
            <p className="mt-2 text-gray-600">
              Créer une nouvelle institution (ministère ou établissement)
            </p>
          </div>
        </div>
          ...
          <form onSubmit={handleSubmit} className="card space-y-6">
            <div>
              ...
              <input
                ...
                placeholder="Ex: Ministère de la Transformation Numérique"
              />
            </div>
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-gray-500">
                Les institutions ministérielles nécessitent une validation MSGG
              </p>
            </div>
            ...
            <div>
              ...
              {logoPreview ? (
                <div className="mt-1 border border-gray-300 rounded-md p-4">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-sm font-medium text-gray-900">Aperçu du logo:</span>
                    <button
                      type="button"
                      onClick={removeLogo}
                  ...
                  <div className="mt-3">
                    ...
                    >
                      ...
                      <p className={`mt-1 text-sm ${isDragOver ? 'text-mauritania-green' : 'text-gray-600'}`}>
                        {isDragOver ? 'Déposez le nouveau logo ici' : 'Glissez un nouveau logo ici ou'}
                      </p>
                  ...
                  <div className="space-y-1 text-center">
                    ...
                    <div className="flex flex-col text-sm text-gray-600">
                      <p className={`${isDragOver ? 'text-mauritania-green font-medium' : ''}`}>
                        {isDragOver ? 'Déposez le logo ici' : 'Glissez et déposez votre logo ici, ou'}
                      </p>
                      {!isDragOver && (
              ...
              <p className="mt-2 text-sm text-gray-500">
                Le logo apparaîtra sur les documents PDF générés
              </p>
            </div>
            ...
            <div>
              ...
              />
              <p className="mt-1 text-sm text-gray-500">
                Texte qui apparaîtra en haut des documents PDF
              </p>
            </div>
            ...
            <div>
              ...
              />
              <p className="mt-1 text-sm text-gray-500">
                Texte qui apparaîtra en bas des documents PDF
              </p>
            </div>
