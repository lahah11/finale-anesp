-- Migration pour le système complet de gestion des missions
...
CREATE TABLE IF NOT EXISTS missions (
    ...
    -- Statut et workflow
    status TEXT DEFAULT 'draft', -- 'draft', 'pending_technical', 'pending_logistics', 'pending_finance', 'pending_dg', 'validated', 'rejected'
...
CREATE TABLE IF NOT EXISTS mission_participants (
    ...
    participant_type TEXT NOT NULL, -- 'anesp' ou 'external'
...
CREATE TABLE IF NOT EXISTS vehicles (
    id TEXT PRIMARY KEY DEFAULT (lower(hex(randomblob(16)))),
    institution_id TEXT NOT NULL,
    vehicle_type TEXT NOT NULL, -- 'car', 'truck', 'bus'
    brand TEXT NOT NULL,
    model TEXT NOT NULL,
    ...
    capacity INTEGER, -- nombre de passagers
...
CREATE TABLE IF NOT EXISTS drivers (
    ...
    license_type TEXT NOT NULL, -- 'B', 'C', 'D'
...
CREATE TABLE IF NOT EXISTS mission_allowances (
    id TEXT PRIMARY KEY DEFAULT (lower(hex(randomblob(16)))),
    institution_id TEXT NOT NULL,
    profile_type TEXT NOT NULL, -- 'director', 'engineer', 'technician', 'driver', 'external'
...
CREATE TABLE IF NOT EXISTS mission_documents (
    id TEXT PRIMARY KEY DEFAULT (lower(hex(randomblob(16)))),
    mission_id TEXT NOT NULL,
    document_type TEXT NOT NULL, -- 'authorization', 'mission_order', 'route', 'budget', 'fuel_exit', 'budget_usage'
...
CREATE TABLE IF NOT EXISTS notifications (
    ...
    mission_id TEXT,
    notification_type TEXT NOT NULL, -- 'mission_created', 'mission_validated', 'mission_rejected', 'document_generated'
    title TEXT NOT NULL,
